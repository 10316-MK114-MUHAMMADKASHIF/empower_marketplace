...
<div>
    @if($sent)
        <div class="text-center py-6">
            ...
            <h4 class="text-base font-semibold text-[#173045] mb-1">Check your email</h4>
            <p class="text-sm text-[#5d6e7f]">We've sent a password reset link to {{ $email }}.</p>
        </div>
    @else
        <form wire:submit="sendResetLink" novalidate>
            <div class="mb-4">
                <label class="block text-sm font-medium text-[#173045] mb-1.5" for="fpf-email">Email address</label>
        ...
        <p class="mt-6 text-center text-sm text-[#5d6e7f]">
            ...
            <a href="{{ route('login') }}" wire:navigate class="font-semibold text-[#12304f] hover:text-[#76c8c0] transition-colors">Log in</a>
        </p>
    @endif
</div>
