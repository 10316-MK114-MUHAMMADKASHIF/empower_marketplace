...
<head>
    ...
    <title>Create Account — {{ config('app.name', 'Empower') }}</title>
...
<body class="min-h-screen bg-[#f4f7fb] font-sans antialiased flex flex-col">
    ...
    <div style="background: radial-gradient(circle at top right, rgba(118,200,192,0.2), transparent 32%), linear-gradient(145deg, #12304f 0%, #1c416a 100%); padding: 1.75rem 0;">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="text-2xl font-bold text-white mb-1">Get started</h1>
            <p class="text-white/50 text-sm">Create an account, then head over to Packages to purchase your first plan.</p>
        </div>
    </div>
            ...
            <div class="max-w-xl mx-auto">
                <div class="bg-white border border-[#dbe4ee] rounded-[1.25rem] shadow-[0_18px_50px_rgba(10,32,55,0.08)] overflow-hidden">
                    ...
                    <div class="flex border-b border-[#dbe4ee] px-5 pt-4">
                        <a href="{{ route('login') }}" class="pb-3 px-4 text-sm font-medium text-[#1a7aad] border-b-2 border-transparent -mb-px hover:text-[#12304f] transition-colors">Login</a>
                        <span class="pb-3 px-4 text-sm font-semibold text-[#12304f] border-b-2 border-[#12304f] -mb-px cursor-default">Sign Up</span>
                    </div>

                    <div class="px-5 py-5">
                        <h3 class="text-lg font-semibold text-[#173045] mb-1">Sign Up</h3>
                        <p class="text-xs text-[#5d6e7f] mb-5">Create an account, then head over to Packages to purchase your first plan.</p>
